...
console.log('HOSTNAME environment variable:', process.env.HOSTNAME);
...
startServer({
  ...
  isDev: false,
  config: nextConfig,
  hostname: isNaN(Number(process.env.PORT)) ? undefined : hostname,
  port: currentPort,
  allowRetry: false,
  keepAliveTimeout,
}).then(() => {
